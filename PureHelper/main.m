...
#import "PSHAppDelegateWithScene.h"
#import "PSHSceneDelegate.h"
#import <PSUtil.h>
...
BOOL sceneDelegateFix(void)
{
	...
	{
		Class newClass = objc_allocateClassPair([PSHSceneDelegate class], sceneDelegateClassName.UTF8String, 0);
...
int main(int argc, char *argv[], char *envp[]) {
	@autoreleasepool {
		...
		if(sceneDelegateFix())
		{
			return UIApplicationMain(argc, argv, nil, NSStringFromClass(PSHAppDelegateWithScene.class));
		}
		else
		{
			return UIApplicationMain(argc, argv, nil, NSStringFromClass(PSHAppDelegateNoScene.class));
		}
	}
}
