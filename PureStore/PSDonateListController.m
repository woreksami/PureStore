...
@implementation PSDonateListController
...
{
	[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=opa334@protonmail.com&item_name=PureStore"] options:@{} completionHandler:^(BOOL success){}];
}
...
- (NSMutableArray*)specifiers
{
	if(!_specifiers)
	{
		...
		[opaGroupSpecifier setProperty:@"Opa developed the ChOma library, helped with automating the bug using it and integrated it into PureStore." forKey:@"footerText"];
