...
#define PureStoreErrorDomain @"PureStoreErrorDomain"

#define TS_MARKER @"_PureStore"
#define TS_LITE_MARKER @"_PureStoreLite"
#define TS_NAME @"PureStore"
...
#define APP_ID @"com.purestore.PureStoreLite"
...
#define APP_ID @"com.purestore.PureStore"
...
extern void fetchLatestPureStoreVersion(void (^completionHandler)(NSString* latestVersion));
...
// was used via the PSPreAppliedExploitType Info.plist key. The corresponding value should be
// (number of bits to left-shift + 1).
typedef enum
{
	// CVE-2022-26766
    // PSPreAppliedExploitType = 1
	EXPLOIT_TYPE_CUSTOM_ROOT_CERTIFICATE_V1 = 1 << 0,

	// CVE-2023-41991
    // PSPreAppliedExploitType = 2
